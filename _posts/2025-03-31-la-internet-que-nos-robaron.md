...
La arquitectura de la sindicación era federada: cada quien podía emitir su feed, y cada quien podía consumir los feeds de otros. Esta cultura cívica digital y distribuida hacía que cada lector fuese también editor. Las recomendaciones eran de pares, mediante blogrolls, comentarios o enlaces cruzados. Las plataformas no tenían poder para reordenar ni priorizar lo que leías. Nadie te vigilaba. ((Urteaga, E. (2019). *Le désenchantement de l’utopie numérique*. Historia y Comunicación Social. [https://doi.org/10.5209/HICS.64500](https://doi.org/10.5209/HICS.64500))). 

Existe bastante documentación acerca del declive de este modo de construir el paisaje digital(([Un estudio](https://obs.obercom.pt/index.php/obs/article/view/1879) sobre la evolución de la comunicación política digital entre 2011 y 2019 evidencia una disminución significativa en el uso de blogs por parte de los candidatos políticos en España. Mientras que en 2011 los blogs eran una herramienta común, para 2019 su uso había prácticamente desaparecido, siendo reemplazados por plataformas como Twitter e Instagram. Además, [un análisis](https://arxiv.org/abs/1202.3492?utm_source=chatgpt.com) de acceso a artículos web muestra que la atención hacia las publicaciones en línea disminuye con el tiempo, siguiendo una ley de potencia inversa. Esto sugiere que los blogs, al no contar con mecanismos de promoción continua, pierden visibilidad rápidamente en un paisaje de cultura desechable. [Un informe de Freedom House](https://freedomhouse.org/es/article/new-report-election-meddling-and-growing-assault-free-expression-online-led-14th?utm_source=chatgpt.com) destaca que en al menos 43 países se han registrado ataques o asesinatos en represalia por la expresión y activismo en línea. Este entorno restrictivo ha contribuido al declive de la libertad en Internet por decimocuarto año consecutivo, limitando la participación en espacios abiertos y fomentando la autocensura.)).
